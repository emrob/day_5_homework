...
class TestPetShop < Minitest::Test
  ...
  # I amended the tests in the next 3 questions, as I didn't think it made sense to add a pet to a customer that didn't come from the pet shop, it makes more sense to add a pet to a customer based on the pets name. I also added in @pet_shop as an argument so the function now requires three parameters, this is just to make it match the other questions, it's just me being crazy. Original tests are included in comments.
  ...
  def test_add_pet_to_customer
    customer = @customers[0]
    add_pet_to_customer(@pet_shop, customer, "Arthur")
    assert_equal(1, customer_pet_count(customer))
  end
  ...
  def test_customer_can_afford_pet__insufficient_funds
    customer = @customers[1]
    can_buy_pet = customer_can_afford_pet(@pet_shop, customer, "Arthur")
    assert_equal(false, can_buy_pet)
  end
  ...
  def test_sell_pet_to_customer__pet_found
    ...
    sell_pet_to_customer(@pet_shop, customer, "Arthur")
  ...
  def test_sell_pet_to_customer__pet_not_found
    ...
    sell_pet_to_customer(@pet_shop, customer, "Dave")
